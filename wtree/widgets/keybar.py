...
Currently wired: F2 (Ren), F3 (View), F4 (Edit), F5 (Copy), F6 (Move), F7 (New), F8 (Del), F9 (Menu), F10 (Quit). Everything else renders dimmed.
...
_WIRED: frozenset[int] = frozenset({2, 3, 4, 5, 6, 7, 8, 9, 10})
