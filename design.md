...
v0 is **functionally complete** as of 2026-05-22 (294/294 tests green). Remaining design work for v0.x and beyond is parked on `todo.md` under the per-era follow-up sections. No architectural blockers.
